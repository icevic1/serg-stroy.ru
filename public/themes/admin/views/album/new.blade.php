<div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
        <button type="button" class="btn btn-primary btn-sm" data-action='NEW' data-load-to='#entry-album' data-href='{{Trans::to('admin/album/album/create')}}'><i class="fa fa-times-circle"></i> {{ trans('Добавить') }}</button>
